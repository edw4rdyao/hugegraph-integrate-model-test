...
class DGI(nn.Module):
    ...
    def forward(self, graph, feat):
        ...
        """
        positive = self.encoder(graph, feat, corrupt=False)  # Encode positive samples without corruption
        negative = self.encoder(graph, feat, corrupt=True)  # Encode negative samples with feature corruption
